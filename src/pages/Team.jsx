  ...
  const teamMembers = [
    {
      ...
      bio: '일본과 한국의 문화적 차이를 이해하고 이를 바탕으로 혁신적인 비즈니스 모델을 창출하는 것을 전문으로 합니다. 한동대학교에서 데이터과학을 전공하고, 다양한 프로젝트 경험을 바탕으로 Spica 327를 설립했습니다.',
      japaneseBio: '日本と韓国の文化的差異を理解し、それを基に革新的なビジネスモデルを創造することを専門としています。韓国の大学でデータサイエンスを専攻し、様々なプロジェクトの経験を基にスピカ327を設立しました。',
    ...
    },
    {
      ...
      department: 'leadership',
      image: '/api/placeholder/300/300',
      bio: '일본과 한국의 문화적 차이를 이해하고 이를 바탕으로 혁신적인 비즈니스 모델을 창출하는 것을 전문으로 합니다. 한동대학교에서 경영학을 전공하고, 다양한 프로젝트 경험을 바탕으로 Spica 327를 설립했습니다.',
      japaneseBio: '日本と韓国の文化的差異を理解し、それを基に革新的なビジネスモデルを創造することを専門としています。韓国の大学でデータサイエンスを専攻し、様々なプロジェクトの経験を基にスピカ327を設立しました。',
      skills: ['전략 기획', '비즈니스 개발', '글로벌 마케팅'],
      japaneseSkills: ['戦略企画', 'ビジネス開発', 'グローバルマーケティング'],
    ...
    },
    {
      ...
      department: 'design',
      image: '/api/placeholder/300/300',
      bio: '사용자 경험과 인터페이스 디자인을 전문으로 하는 디자이너입니다. 토스에서 1년간 근무하며 다양한 제품의 UX/UI를 담당했고, 현재 Spica 327의 브랜드 아이덴티티와 사용자 경험을 설계하고 있습니다.',
      japaneseBio: 'ユーザーエクスペリエンスとインターフェースデザインを専門とするデザイナーです。トスで1年間勤務し、様々な製品のUX/UIを担当し、現在スピカ327のブランドアイデンティティとユーザーエクスペリエンスを設計しています。',
      skills: ['UX/UI 디자인', '브랜드 디자인', '프로토타이핑'],
      japaneseSkills: ['UX/UIデザイン', 'ブランドデザイン', 'プロトタイピング'],
      email: 'chae@spica327.com',
    ...
    },
    {
      ...
      image: '/api/placeholder/300/300',
      bio: '풀스택 개발과 서버 및 보안을 전문으로 하는 엔지니어입니다. 다양한 스타트업에서 1년간 근무하며 대규모 서버 및 핀테크 프로젝트를 개발했고, 현재 Spica 327의 핵심 플랫폼 개발을 담당하고 있습니다.',
      japaneseBio: 'フルスタック開発とサーバーとセキュリティを専門とするエンジニアです。様々なスタートアップで1年間勤務し、大規模サーバーとフィンテックプロジェクトを開発し、現在スピカ327のコアプラットフォーム開発を担当しています。',
      skills: ['React/Node.js', 'SQL', 'DevOps', 'Server'],
      japaneseSkills: ['React/Node.js', 'SQL', 'DevOps', 'Server'],
      email: 'yoonsung@spica327.com',
      linkedin: 'https://linkedin.com/in/yoonsung-choi',
      github: 'https://github.com/yoonsung-choi',
      experience: '5년',
    ...
    },
    {
      ...
      image: '/api/placeholder/300/300',
      bio: '디지털 마케팅과 브랜드 전략을 전문으로 하는 마케터입니다. 높은 열정과 리더십으로 현재 Spica 327의 글로벌 마케팅 전략을 수립하고 있습니다.',
      japaneseBio: 'デジタルマーケティングとブランド戦略を専門とするマーケターです。高い熱意とリーダーシップで、現在スピカ327のグローバルマーケティング戦略を策定しています。',
      skills: ['디지털 마케팅', '브랜드 전략', '콘텐츠 마케팅', '리더십'],
      japaneseSkills: ['デジタルマーケティング', 'ブランド戦略', 'コンテンツマーケティング'],
      email: 'taro@spica327.com',
    ...
    },
    {
      ...
      id: 8,
      name: '전세연',
      japaneseName: 'チョン・セヨン',
      position: 'Realese Manager',
      japanesePosition: 'リリースマネージャー',
      location: '포항, 대한민국',
      japaneseLocation: 'ポウハン, 韓国',
      department: 'development',
      image: '/api/placeholder/300/300',
      bio: '시스템의 QA와 개발 일정을 관리감독하는 릴리즈 매니저입니다.',
      japaneseBio: 'システムのQAと開発の日程を管理監督するリリースマネージャーです。',
      skills: ['QA', 'React/Java', 'Unity'],
      japaneseSkills: ['QA', 'React/Java', 'Unity'],
      email: 'jeonseyeon8653@gmail.com',
      linkedin: 'https://www.linkedin.com/in/%EC%A0%84-%EC%84%B8%EC%97%B0-1139b739b/',
      github: 'https://github.com/Jeon-Se-Yeon',
      experience: '1년',
      education: '한동대학교 전산전자공학부'
    },
    {
      id: 9,
      name: '누군가',
